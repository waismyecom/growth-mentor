...
- [ ] Daily commitments/evidence, seven-domain objective audit with snapshots and two lowest domains.
- [ ] Persist multi-turn diagnostic ending in exactly one corrective action.
- [ ] Rewards, voluntary stakes, days remaining, quarterly progress and daily alignment.
- [ ] Verify create/edit/reload and failure states; test zero/missing evidence and historical stability.
- [ ] Typecheck/build; commit and push; verify deployment.
