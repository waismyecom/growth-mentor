...
export type Commitment = {id:string;title:string;domain:string;weekly_target:number;unit:string;archived:boolean;goal_id:string|null};
...
export type WorkspaceData = {vision:{statement:string;target_date:string};goals:Goal[];cards:Card[];commitments:Commitment[];logs:Log[];audits:Audit[];diagnostics:Diagnostic[]};
